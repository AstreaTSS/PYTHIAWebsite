...
Your priority should be _setting up the player role._ This can be done pretty easily: select the `/config player set` command and use the role you wish to be able to use the various features of PYTHIA. It's worth noting that _no other role will be able to use features, not even staff_ (though staff will still be able to set up and manage features).
